...
type Training struct {
	...
	Action       int64         // количество повторов(шаги, гребки при плавании)
...
func (t Training) distance() float64 {
	return float64(t.Action) * t.LenStep / MInKm //преодолённая_дистанция_за_тренировку_в_км
}
...
func (t Training) meanSpeed() float64 {
	...
	return t.distance() / t.Duration.Hours() //преодолённая_дистанция_за_тренировку_в_км / время_тренировки_в_часах
}
...
func (r Running) Calories() float64 {
	speed := ((CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
	return speed
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(speedMs, 2)/float64(w.Height)*CmInM)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
}
